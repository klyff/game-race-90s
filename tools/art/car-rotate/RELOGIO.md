...
**Do not use.** Live playable cars use the 32-frame CCW spinner clock: `public/assets/cars/RELOGIO.md` (index 0 = 6h, +11.25° CCW, hero = frame 07). Skill: isometric-car-spinner.
