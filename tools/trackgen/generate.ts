 ...
 * (`src/data/tracks/generated-tracks.ts`) that the registry re-exports. World 1
 * tracks I + II stay hand-authored (`thunder-basin`, `thunder-basin-2`);
...
// Authored World 1 tracks (thunder-basin, thunder-basin-2) are NOT in this list.
