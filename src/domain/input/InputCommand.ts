 ...
 *
 * Weapon keys: missile `C`, oil `Z`, landmine `X`, turbo Left-Shift or `A`.
 * Space is the race brake. Adapters edge-trigger weapons so a held button
 * cannot dump the whole inventory in one frame.
 */
