...
/**
 * Every circuit in the game: hand-authored World 1 I + II and Bogmire I,
 * then the procedurally generated tracks from `npm run gen:tracks`.
 */
export const TRACKS: readonly TrackDefinition[] = [
  thunderBasin,
  thunderBasinTwo,
  bogmireDeepOne,
  ...GENERATED_TRACKS.filter(track => track.id !== 'bogmire-deep-1'),
];
